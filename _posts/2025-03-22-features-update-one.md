...
# Welcome to diagramming!
Diagramming is now possible thanks to GitHub-flavoured Markdown and the [Mermaid](https://mermaid.js.org/) project. Here's what an example looks like:
```mermaid
flowchart LR
  A --> B
```
...
# Welcome to the world of sheet music!
Sheet music display and playback is now added via [abcjs](https://www.abcjs.net). Here is an example:
```abc
%hidecode
X: 1
T: Cooley's
